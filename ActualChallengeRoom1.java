...
public class ActualChallengeRoom1 extends RoomSuperclass {
    ...
    private static final String CM1_IMAGE =
            "https://cdnb.artstation.com/p/assets/images/images/011/503/865/original/joe-dupras-revenant.gif?1529933269";
    private Node cm2;
    private Image cm2Image;
    private static final String CM2_IMAGE = //bat woman
            "http://www.astronomicgames.com/images/assets/GIF%20Vampire%20Queen%20Bat%20transform.gif";
    private Node cm3;
    private Image cm3Image;
    private static final String CM3_IMAGE =
            "https://cdn.gamedevmarket.net/wp-content/uploads/20191203193414/df40ac67288c750b6c22fc915450925737e9dbfb.gif";
    ...
    public ActualChallengeRoom1(int width, int height) {
        super(width, height);
        cm1Defeated = false;
        cm2Defeated = false;
        cm3Defeated = false;
    ...
    @Override
    public void setMonster2HPNum(int monster2HP) {

    }

    @Override
    public void setMonster3HPNum(int monster3HP) {
